...
export default function EclipseSection({
  ...
  return (
    <section id="eclipse" className="section-parchment relative overflow-hidden">
      <div
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
          ...
          <div className="flex-1">
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
              {[
                ...
                <div key={item.label} className="rounded-lg border border-gold-500/25 bg-cream-50/60 p-4">
                  <p className="font-display text-[9px] font-semibold uppercase tracking-[0.15em] text-gold-600">
                    {item.label}
                  </p>
                  <p className="mt-1.5 font-serif text-base text-navy-900">
                    {item.value}
                  </p>
                </div>
              ))}
            </div>
            <p className="mt-5 font-serif text-base italic leading-relaxed text-navy-800/70">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6 rounded-xl border border-gold-500/20 bg-cream-50/50 p-6 sm:p-8">
            ...
            <p className="font-serif text-base leading-relaxed text-navy-800/85">
            ...
            <div className="pt-4 border-t border-gold-500/15">
              ...
              <p className="mt-3 font-serif text-base leading-relaxed text-navy-800/85">
          ...
          <div className="flex flex-col justify-between rounded-xl border-2 border-gold-400/40 bg-gold-400/10 p-6 sm:p-8">
            <div>
              <div className="flex items-center justify-between">
                <span className="font-display text-[10px] font-semibold uppercase tracking-[0.2em] text-gold-700">
                  Personalized Forecast
                </span>
                <span className="font-display text-xs font-bold uppercase tracking-widest text-navy-900">
              ...
              <p className="mt-4 font-serif text-lg leading-relaxed text-navy-900/90">
            ...
            <div className="mt-8 pt-4 border-t border-gold-500/20 flex items-center gap-2 text-xs font-display uppercase tracking-wider text-gold-700">
