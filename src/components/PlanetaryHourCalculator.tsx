...
function getCurrentPlanetaryHour(date: Date) {
  ...
  // Between midnight and 6am the night period began at 6pm yesterday
  if (hour < 6) {
  ...
  const periodLength = 12 * 60; // 12 hours in minutes
  const planetaryHourLength = periodLength / 7; // 7 planetary hours per period
